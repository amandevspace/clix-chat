          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2.5 hover:opacity-80 transition-all">
              <div className="relative size-9 rounded-lg bg-primary/10 flex items-center justify-center">
                ...
                {authUser && (
                  <span className="absolute top-0.5 right-0.5 size-2 rounded-full bg-success ring-2 ring-base-100" />
                )}
              </div>
              ...
              <>
                <Link
                  ...
                  className={`btn btn-sm gap-2 ${
                    isActive("/profile") ? "btn-primary" : "btn-ghost"
                  }`}
                >
                  {initials ? (
                ...
                <button
                  className="flex gap-2 items-center btn btn-sm btn-ghost hover:btn-error hover:text-error transition-colors"
                  onClick={logout}
                >
